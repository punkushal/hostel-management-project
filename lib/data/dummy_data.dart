import 'package:hostel_management_project/models/category.dart';

const categories = [
  Category(image: 'assets/images/door.png', title: 'Rooms Availability'),
  Category(image: 'assets/images/mail-box.png', title: 'All Issues'),
  Category(image: 'assets/images/student.png', title: 'Manage Student'),
